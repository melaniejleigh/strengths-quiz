...
var Q = [
  [1,"My friends ask me to tell stories.","My friends ask my advice.",["communication", "woo"],["individualization", "relator"],"communication","individualization"],
  [2,"I am a perfectionist.","I am a person who gets things done.",["maximizer", "discipline"],["achiever", "responsibility"],"maximizer","achiever"],
  [3,"I like spending time with futurists.","I like spending time with historians.",["futuristic", "ideation"],["context", "intellection"],"futuristic","context"],
  [4,"I strive to win first place.","I enjoy playing the game.",["competition", "achiever"],["harmony", "positivity"],"competition","harmony"],
  [5,"I have always worked hard.","I am a slow, but steady performer.",["achiever", "responsibility"],["deliberative", "consistency"],"achiever","deliberative"],
  [6,"I think about what I do well.","I think about what I must improve.",["maximizer", "self_assurance"],["restorative", "deliberative"],"maximizer","restorative"],
  [7,"I am a sensitive person.","I am a logical person.",["empathy", "connectedness"],["analytical", "deliberative"],"empathy","analytical"],
  [8,"I can pick out just the right gift.","I give gifts that anyone would like.",["individualization", "empathy"],["consistency", "includer"],"individualization","consistency"],
  [9,"Starting conversations is an effort for me.","I get a rush from striking up a conversation with a stranger.",["intellection", "relator"],["woo", "communication"],"intellection","woo"],
  [10,"I feel great about life.","I feel I am a competent person.",["positivity", "adaptability"],["self_assurance", "belief"],"positivity","self_assurance"],
  [11,"I am patient when someone struggles.","I think people do better when someone pushes them.",["developer", "empathy"],["command", "activator"],"developer","command"],
  [12,"I can make people feel important to me.","I can make people feel successful.",["relator", "individualization"],["developer", "maximizer"],"relator","developer"],
  [13,"My view of humanity guides my life.","My ambition guides my life.",["belief", "connectedness"],["significance", "achiever"],"belief","significance"],
  [14,"I find it satisfying when people confide in me.","I want to be a leader of others.",["relator", "empathy"],["command", "significance"],"relator","command"],
  [15,"I like to follow steps.","I love looking at things from different angles.",["discipline", "consistency"],["ideation", "strategic"],"discipline","ideation"],
  [16,"I am happiest when things are running smoothly.","I am happiest when I have a problem to solve.",["harmony", "consistency"],["restorative", "analytical"],"harmony","restorative"],
  [17,"Following proven methods keeps me from mistakes others have made.","I am good at reorganizing things to be more efficient.",["context", "deliberative"],["arranger", "strategic"],"context","arranger"],
  [18,"Everyday I talk about my visions for the future.","I set aside planning times to think about the future.",["communication", "futuristic"],["futuristic", "focus"],"communication","futuristic"],
  [19,"I can get other people excited.","I can calm others down.",["activator", "positivity"],["harmony", "empathy"],"activator","harmony"],
  [20,"Once I have made a decision, I have to act.","I need to be sure I am right before I take action.",["activator", "command"],["deliberative", "analytical"],"activator","deliberative"],
  [21,"I concentrate harder than most people on what I want to get done.","I go with the flow and keep an overview of issues.",["focus", "achiever"],["adaptability", "strategic"],"focus","adaptability"],
  [22,"Everything happens for a reason.","Coincidences are random and have no special meaning.",["connectedness", "belief"],["analytical", "self_assurance"],"connectedness","analytical"],
  [23,"I am a good conversationalist.","I am a good listener.",["communication", "woo"],["empathy", "relator"],"communication","empathy"],
  [24,"It is natural for me to accept everybody.","I tend to carefully select the people I spend time with.",["includer", "positivity"],["relator", "individualization"],"includer","relator"],
  [25,"I always find new things that capture my interest.","My friends have seldom disappointed me.",["learner", "input"],["relator", "responsibility"],"learner","relator"],
  [26,"I rely on experts to help me find the right answers.","I am a creative, strategic thinker and patterns naturally emerge for me.",["analytical", "input"],["strategic", "ideation"],"analytical","strategic"],
  [27,"I am fully alive, full of joy and delight.","I am aware of all the factors affecting the situation.",["positivity", "adaptability"],["analytical", "deliberative"],"positivity","analytical"],
  [28,"I want to lead a large group of people.","I help people see how they are connected.",["command", "significance"],["connectedness", "includer"],"command","connectedness"],
  [29,"I sometimes intimidate others.","Well-known leaders intimidate me.",["command", "self_assurance"],["deliberative", "harmony"],"command","deliberative"],
  [30,"I can put myself into someone's life and understand what they are going through.","I have an ability to love all people.",["empathy", "connectedness"],["includer", "connectedness"],"empathy","includer"],
  [31,"I push others to succeed.","I make other people happy.",["command", "developer"],["positivity", "harmony"],"command","positivity"],
  [32,"I am a carefree person.","I am more mature than my associates and friends.",["adaptability", "positivity"],["responsibility", "discipline"],"adaptability","responsibility"],
  [33,"I act on every opportunity.","I am careful to avoid making mistakes.",["activator", "self_assurance"],["deliberative", "responsibility"],"activator","deliberative"],
  [34,"By studying history I can figure out the future.","My future will be independent of my past.",["context", "strategic"],["futuristic", "self_assurance"],"context","futuristic"],
  [35,"I am part of something larger than myself.","I am a realistic person.",["connectedness", "belief"],["analytical", "deliberative"],"connectedness","analytical"],
  [36,"I want work to be a way of life for me.","Work is just a way to earn a living.",["achiever", "responsibility"],["adaptability", "positivity"],"achiever","adaptability"],
  [37,"I feel sad when someone doesn't like me.","I feel guilty when I do anything that I don't think is right.",["empathy", "relator"],["responsibility", "belief"],"empathy","responsibility"],
  [38,"I organize.","I analyze.",["arranger", "discipline"],["analytical", "strategic"],"arranger","analytical"],
  [39,"I am spontaneous.","I am practical.",["adaptability", "activator"],["deliberative", "consistency"],"adaptability","deliberative"],
  [40,"I seek out philosophical people.","I like to associate with hardworking, achieving people.",["intellection", "learner"],["achiever", "competition"],"intellection","achiever"],
  [41,"I enjoy making others feel worthwhile.","I enjoy making others feel successful.",["developer", "empathy"],["developer", "maximizer"],"developer","developer"],
  [42,"I use instinct to solve problems.","I use exact, well-researched information.",["strategic", "self_assurance"],["analytical", "input"],"strategic","analytical"],
  [43,"I have a healthy skepticism about life.","I believe I am connected with all of humankind.",["deliberative", "analytical"],["connectedness", "includer"],"deliberative","connectedness"],
  [44,"I like to take things apart.","If it's not broken, don't fix it.",["restorative", "analytical"],["consistency", "discipline"],"restorative","consistency"],
  [45,"I prefer to be around people like me.","I feel bad when other people are left out.",["relator", "individualization"],["includer", "empathy"],"relator","includer"],
  [46,"I can keep up with most people and am not driven to work harder or longer.","I have great stamina and have always worked harder and longer than most.",["adaptability", "harmony"],["achiever", "focus"],"adaptability","achiever"],
  [47,"A bigger title motivates me.","A bigger mission motivates me.",["significance", "command"],["belief", "connectedness"],"significance","belief"],
  [48,"I am a very tidy person.","I am very stubborn.",["discipline", "consistency"],["command", "self_assurance"],"discipline","command"],
  [49,"People often share their feelings with me.","I tend to have an objective outlook.",["empathy", "relator"],["analytical", "deliberative"],"empathy","analytical"],
  [50,"I follow a written plan for my future.","I discover the future one day at a time.",["focus", "futuristic"],["adaptability", "self_assurance"],"focus","adaptability"],
  [51,"I focus on what I can achieve in the future.","I imagine how I will respond to whatever happens.",["futuristic", "focus"],["adaptability", "deliberative"],"futuristic","adaptability"],
  [52,"I stay connected to my long-term friends.","I am continually expanding my network of friends.",["relator", "responsibility"],["woo", "includer"],"relator","woo"],
  [53,"I include everybody so I don't hurt anyone's feelings.","I select my friends carefully.",["includer", "empathy"],["relator", "individualization"],"includer","relator"],
  [54,"My ego is not so large that I need to be recognized.","It is very important to me to be recognized as credible and successful.",["harmony", "self_assurance"],["significance", "achiever"],"harmony","significance"],
  [55,"I enjoy understanding the causes of major wars.","I enjoy thinking about what the world will be like in fifty years.",["context", "intellection"],["futuristic", "ideation"],"context","futuristic"],
  [56,"I am analytical about issues facing my life.","I am passionate about issues that affect my life.",["analytical", "deliberative"],["belief", "empathy"],"analytical","belief"],
  [57,"I make progress by capitalizing on my talents.","I make progress by overcoming my weaknesses.",["maximizer", "self_assurance"],["restorative", "deliberative"],"maximizer","restorative"],
  [58,"For me everything has to be planned.","I prefer to go with the flow.",["discipline", "focus"],["adaptability", "positivity"],"discipline","adaptability"],
  [59,"I find different ways to get things done.","I prefer routine ways for getting things done.",["arranger", "strategic"],["consistency", "discipline"],"arranger","consistency"],
  [60,"I feel bad when other people are left out.","My favorite times are when I am with good friends.",["includer", "empathy"],["relator", "positivity"],"includer","relator"],
  [61,"I judge people based on their character.","I welcome everyone.",["individualization", "deliberative"],["includer", "positivity"],"individualization","includer"],
  [62,"I think most people will steal if the conditions are right.","I believe that people who steal should be punished.",["deliberative", "analytical"],["responsibility", "belief"],"deliberative","responsibility"],
  [63,"What happens today is the result of history.","We invent the future one day at a time.",["context", "analytical"],["futuristic", "activator"],"context","futuristic"],
  [64,"I love it when things are working perfectly.","I love the process of fixing things.",["maximizer", "consistency"],["restorative", "analytical"],"maximizer","restorative"],
  [65,"I rely on experts to help me find the right answers.","Answers and issues naturally emerge for me to see.",["input", "analytical"],["strategic", "ideation"],"input","strategic"],
  [66,"I am very generous in giving praise.","I am selective in giving praise.",["positivity", "developer"],["deliberative", "maximizer"],"positivity","deliberative"],
  [67,"I am never fully satisfied unless I am number one.","I am happy to be among the top group.",["competition", "achiever"],["competition", "harmony"],"competition","competition"],
  [68,"I am good at figuring out how different people can work together.","I am good at treating everyone equally.",["arranger", "individualization"],["consistency", "includer"],"arranger","consistency"],
  [69,"I try to stay within my comfort zone.","I am a thrill-seeker.",["deliberative", "focus"],["activator", "adaptability"],"deliberative","activator"],
  [70,"I can sense other people's feelings.","I enjoy discussing big ideas.",["empathy", "connectedness"],["intellection", "ideation"],"empathy","intellection"],
  [71,"I am always thinking about how to be more efficient.","I follow a regular routine.",["arranger", "maximizer"],["discipline", "consistency"],"arranger","discipline"],
  [72,"I trust my heart for important decisions.","I use my head for important decisions.",["empathy", "belief"],["analytical", "deliberative"],"empathy","analytical"],
  [73,"I respond to things as they occur.","I prioritize things, then act.",["adaptability", "activator"],["focus", "discipline"],"adaptability","focus"],
  [74,"I like everybody.","I want everybody to like me.",["includer", "positivity"],["woo", "significance"],"includer","woo"],
  [75,"I am driven by my goals.","I am driven by my mission.",["achiever", "focus"],["belief", "connectedness"],"achiever","belief"],
  [76,"I set performance objectives each week.","My work is determined by the demands of the day.",["focus", "discipline"],["adaptability", "responsibility"],"focus","adaptability"],
  [77,"I like to take care of the present.","I live for the future.",["adaptability", "responsibility"],["futuristic", "focus"],"adaptability","futuristic"],
  [78,"I have to force myself to study.","I can concentrate on the things in which I am interested.",["discipline", "responsibility"],["focus", "learner"],"discipline","focus"],
  [79,"Being trustworthy is important.","Being successful is important.",["responsibility", "belief"],["significance", "achiever"],"responsibility","significance"],
  [80,"I accept what life gives me.","I like to get perspective by seeing patterns emerge.",["adaptability", "harmony"],["strategic", "connectedness"],"adaptability","strategic"],
  [81,"I study what motivates other people.","I am introspective.",["individualization", "empathy"],["intellection", "self_assurance"],"individualization","intellection"],
  [82,"I follow a routine.","I am zestful.",["discipline", "consistency"],["positivity", "adaptability"],"discipline","positivity"],
  [83,"I read about social issues in my free time.","I watch sports or entertainment to unwind.",["belief", "input"],["adaptability", "positivity"],"belief","adaptability"],
  [84,"I like to be heard.","I like to listen.",["communication", "significance"],["empathy", "relator"],"communication","empathy"],
  [85,"It is always best to be careful.","I am an open-minded person.",["deliberative", "responsibility"],["adaptability", "ideation"],"deliberative","adaptability"],
  [86,"I am satisfied with my progress in life.","I worry about my future.",["self_assurance", "positivity"],["futuristic", "deliberative"],"self_assurance","futuristic"],
  [87,"I like to talk.","I like to think.",["communication", "woo"],["intellection", "learner"],"communication","intellection"],
  [88,"I pay close attention to people's feelings.","I pay close attention to details.",["empathy", "individualization"],["discipline", "responsibility"],"empathy","discipline"],
  [89,"I am a very down to earth thinker.","I am a creative, strategic thinker.",["analytical", "deliberative"],["strategic", "ideation"],"analytical","strategic"],
  [90,"I seek out people who will be honest about my weaknesses.","I choose to associate with people who appreciate my strengths.",["restorative", "deliberative"],["maximizer", "relator"],"restorative","maximizer"],
  [91,"I have to take care of myself first.","I feel a need to sacrifice for others.",["self_assurance", "focus"],["responsibility", "belief"],"self_assurance","responsibility"],
  [92,"I am extremely social.","I like to work hard with friends.",["woo", "positivity"],["relator", "achiever"],"woo","relator"],
  [93,"I am never at a loss for words.","It is hard for me to talk about myself.",["communication", "self_assurance"],["relator", "deliberative"],"communication","relator"],
  [94,"I am a carefree person.","I am a serious person.",["adaptability", "positivity"],["responsibility", "deliberative"],"adaptability","responsibility"],
  [95,"I love to study.","I live to go out.",["learner", "input"],["woo", "positivity"],"learner","woo"],
  [96,"I am often forgetful.","My nature is to check as often as necessary to be sure everything is in order.",["adaptability", "positivity"],["discipline", "responsibility"],"adaptability","discipline"],
  [97,"I am a keen observer of the differences between people.","I treat all people equally.",["individualization", "empathy"],["consistency", "includer"],"individualization","consistency"],
  [98,"Overcoming weaknesses is my way for achieving.","Building on my talents is my way for achieving.",["restorative", "deliberative"],["maximizer", "self_assurance"],"restorative","maximizer"],
  [99,"When something goes wrong, I see an opportunity.","Problems cause me a lot of stress.",["restorative", "positivity"],["deliberative", "empathy"],"restorative","deliberative"],
  [100,"I am outgoing.","I can be outgoing when I need to be.",["woo", "communication"],["adaptability", "woo"],"woo","adaptability"],
  [101,"I want as many friends as possible.","I want a few deep friendships that are very important to me.",["woo", "includer"],["relator", "individualization"],"woo","relator"],
  [102,"It is sometimes justifiable to bend the truth.","It is never justifiable to tell a lie.",["adaptability", "self_assurance"],["responsibility", "belief"],"adaptability","responsibility"],
  [103,"I want a few friends that I know a lot about.","I am always building new friendships.",["relator", "individualization"],["woo", "includer"],"relator","woo"],
  [104,"I have been known for my neatness.","I have been known for my sense of humor.",["discipline", "consistency"],["positivity", "woo"],"discipline","positivity"],
  [105,"I am creating my future.","I study what the future holds for me.",["activator", "self_assurance"],["futuristic", "intellection"],"activator","futuristic"],
  [106,"I like to challenge people.","I like to encourage people.",["command", "developer"],["developer", "positivity"],"command","developer"],
  [107,"I am a very private person.","My life is an open book.",["deliberative", "relator"],["woo", "communication"],"deliberative","woo"],
  [108,"I am generous.","I am a thrifty person.",["includer", "positivity"],["deliberative", "discipline"],"includer","deliberative"],
  [109,"I am a leader.","I am a high achiever.",["command", "significance"],["achiever", "competition"],"command","achiever"],
  [110,"I sometimes flatter others.","I am conscientious.",["woo", "positivity"],["responsibility", "belief"],"woo","responsibility"],
  [111,"I can study for as long as it takes.","I have a really short attention span.",["focus", "discipline"],["adaptability", "positivity"],"focus","adaptability"],
  [112,"I am careful not to give out too much praise, so when I do it really means something.","I am generous with my praise and recognition.",["maximizer", "deliberative"],["positivity", "developer"],"maximizer","positivity"],
  [113,"I like large gatherings where everyone is welcomed.","I like small gatherings with close friends.",["includer", "woo"],["relator", "individualization"],"includer","relator"],
  [114,"I have a purpose for my life.","My life is very enjoyable.",["belief", "focus"],["positivity", "adaptability"],"belief","positivity"],
  [115,"I enjoy philosophical discussions.","I enjoy goal-setting conferences.",["intellection", "learner"],["achiever", "focus"],"intellection","achiever"],
  [116,"I like to be alone.","I am missing my friends.",["intellection", "relator"],["relator", "includer"],"intellection","relator"],
  [117,"I visualize the future.","I understand what caused the present circumstances.",["futuristic", "ideation"],["context", "analytical"],"futuristic","context"],
  [118,"It is easy for me to admit the truth about myself.","I struggle to be honest with myself.",["self_assurance", "responsibility"],["deliberative", "intellection"],"self_assurance","deliberative"],
  [119,"I am not afraid to talk about who I am.","I am very careful in talking about my private life.",["communication", "self_assurance"],["deliberative", "relator"],"communication","deliberative"],
  [120,"As a child, I was quite aggressive and independent.","As a child, I fit in well and caused no problems.",["command", "activator"],["harmony", "adaptability"],"command","harmony"],
  [121,"I'd rather plan the party.","I'd rather go to the party.",["arranger", "responsibility"],["woo", "positivity"],"arranger","woo"],
  [122,"My actions are guided by my values.","I am always open to new experiences.",["belief", "responsibility"],["adaptability", "learner"],"belief","adaptability"],
  [123,"I encourage others to think things through.","I encourage others to take action.",["analytical", "deliberative"],["activator", "command"],"analytical","activator"],
  [124,"I seek the guidance of others.","No matter the situation, I naturally know the right thing to do.",["input", "deliberative"],["self_assurance", "strategic"],"input","self_assurance"],
  [125,"People who have not figured out their goals irritate me.","I don't like to be around people who can't relax.",["focus", "achiever"],["harmony", "adaptability"],"focus","harmony"],
  [126,"I choose easy courses.","I choose challenging courses.",["adaptability", "harmony"],["achiever", "learner"],"adaptability","achiever"],
  [127,"I dislike deadlines.","My responsibility keeps me going.",["adaptability", "deliberative"],["responsibility", "focus"],"adaptability","responsibility"],
  [128,"I encourage people.","I strengthen people.",["developer", "positivity"],["maximizer", "developer"],"developer","maximizer"],
  [129,"I am too trusting of others.","I am too ambitious.",["includer", "positivity"],["significance", "achiever"],"includer","significance"],
  [130,"What has happened in the past inspires me.","What can be achieved in the future inspires me.",["context", "belief"],["futuristic", "achiever"],"context","futuristic"],
  [131,"Last minute pressure focuses my mind.","My thinking is clearer when I get things done ahead of time.",["activator", "adaptability"],["deliberative", "discipline"],"activator","deliberative"],
  [132,"I think most people will steal if the conditions are right.","I believe that people who steal should be punished.",["deliberative", "analytical"],["responsibility", "belief"],"deliberative","responsibility"],
  [133,"I need to feel excited about my work.","Acceptance is my greatest need.",["positivity", "activator"],["includer", "harmony"],"positivity","includer"],
  [134,"I am a reasonable person.","I am a responsible person.",["harmony", "deliberative"],["responsibility", "belief"],"harmony","responsibility"],
  [135,"Most of my thoughts are with the here and now.","I try to learn as much as I can by studying the past.",["adaptability", "focus"],["context", "learner"],"adaptability","context"],
  [136,"I am satisfied when I do the best I can.","I am driven to make a difference in the world.",["achiever", "responsibility"],["belief", "significance"],"achiever","belief"],
  [137,"I have a great desire to learn.","I need to be known and understood.",["learner", "input"],["significance", "relator"],"learner","significance"],
  [138,"I think a lot about cause and effect.","I take things as they come.",["analytical", "deliberative"],["adaptability", "harmony"],"analytical","adaptability"],
  [139,"Figuring out why I failed.","Enjoying present successes.",["restorative", "analytical"],["positivity", "self_assurance"],"restorative","positivity"],
  [140,"Helping others fills me with purpose.","People should be free to live the life they choose.",["developer", "belief"],["adaptability", "self_assurance"],"developer","adaptability"],
  [141,"I seek responsibility.","I strive for promotions.",["responsibility", "achiever"],["significance", "competition"],"responsibility","significance"],
  [142,"I am agreeable with people.","I take risks.",["harmony", "relator"],["activator", "self_assurance"],"harmony","activator"],
  [143,"I spend 25% of my time thinking about the future.","I spend 70% of my time thinking about the future.",["futuristic", "focus"],["futuristic", "ideation"],"futuristic","futuristic"],
  [144,"I inspire friends to make things happen.","I bring harmony to people who are working together.",["activator", "positivity"],["harmony", "empathy"],"activator","harmony"],
  [145,"I like things that are predictable.","I find change exciting.",["consistency", "deliberative"],["adaptability", "activator"],"consistency","adaptability"],
  [146,"My typical working week is 35-50 hours.","My typical working week is in excess of 60 hours.",["harmony", "responsibility"],["achiever", "focus"],"harmony","achiever"],
  [147,"I am light-hearted.","I am serious.",["positivity", "adaptability"],["deliberative", "responsibility"],"positivity","deliberative"],
  [148,"I want results now.","I am playing the long game.",["activator", "focus"],["futuristic", "deliberative"],"activator","futuristic"],
  [149,"I can get along with anybody.","I select my friends carefully.",["includer", "harmony"],["relator", "individualization"],"includer","relator"],
  [150,"I cry easily.","I am tough-minded.",["empathy", "relator"],["analytical", "command"],"empathy","analytical"],
  [151,"I am an observer of life.","I want to control the events of my life.",["intellection", "adaptability"],["command", "self_assurance"],"intellection","command"],
  [152,"I can concentrate on my work for hours at a time.","An hour is about the max I can concentrate.",["focus", "discipline"],["adaptability", "positivity"],"focus","adaptability"],
  [153,"I am a top achiever.","I consistently deliver positive results.",["competition", "achiever"],["maximizer", "responsibility"],"competition","maximizer"],
  [154,"I can outsmart other people.","Many people intimidate me.",["strategic", "self_assurance"],["deliberative", "harmony"],"strategic","deliberative"],
  [155,"I am at my best managing multiple workstreams at once.","I am at my best going deep on one thing at a time.",["arranger", "adaptability"],["focus", "intellection"],"arranger","focus"],
  [156,"I make it a point to try to be healthy.","I seek out new experiences.",["discipline", "responsibility"],["adaptability", "learner"],"discipline","adaptability"],
  [157,"I am a good initiator.","I always follow through.",["activator", "command"],["responsibility", "achiever"],"activator","responsibility"],
  [158,"I am the one who builds the team.","I am the one who comes up with the idea.",["arranger", "developer"],["ideation", "strategic"],"arranger","ideation"],
  [159,"I think in numbers and data.","I think in stories and images.",["analytical", "input"],["communication", "ideation"],"analytical","communication"],
  [160,"I prefer intellectual discussions.","I prefer to talk about sports or entertainment.",["intellection", "learner"],["adaptability", "woo"],"intellection","adaptability"],
  [161,"The words I use are intellectually stimulating.","My vocabulary consists of practical words.",["communication", "intellection"],["analytical", "focus"],"communication","analytical"],
  [162,"My language consists of short, simple words.","I tend to use many abstract, complex words.",["communication", "woo"],["intellection", "learner"],"communication","intellection"],
  [163,"It is easy for me to put my thoughts into words.","At times, I have trouble expressing my best ideas.",["communication", "self_assurance"],["intellection", "deliberative"],"communication","intellection"],
  [164,"I love to read.","I like to figure out how things work.",["learner", "input"],["restorative", "analytical"],"learner","restorative"],
  [165,"My mind is always going.","I need to be physically active.",["intellection", "ideation"],["activator", "adaptability"],"intellection","activator"],
  [166,"I like lectures.","I like discussion groups.",["learner", "input"],["communication", "includer"],"learner","communication"],
  [167,"I like to study.","I get a thrill from discovering a pattern in data.",["learner", "input"],["analytical", "strategic"],"learner","analytical"],
  [168,"I have a craving to know more.","I have a craving to be rich.",["input", "learner"],["significance", "achiever"],"input","significance"],
  [169,"I always make deadlines.","I follow through and do what I said I would do.",["discipline", "focus"],["responsibility", "achiever"],"discipline","responsibility"],
  [170,"A new idea makes my day.","Completing the tasks expected of me makes my day.",["ideation", "learner"],["responsibility", "achiever"],"ideation","responsibility"],
  [171,"Whenever I am in a group, I seem to have more ideas than the others.","Whenever I am in a group, I seem to be the best prepared.",["ideation", "communication"],["discipline", "responsibility"],"ideation","discipline"],
  [172,"I never stop absorbing information.","I have a gift for simplifying complexities.",["input", "learner"],["communication", "strategic"],"input","communication"],
  [173,"Winning is everything.","Doing it right is everything.",["competition", "achiever"],["responsibility", "discipline"],"competition","responsibility"],
  [174,"My philosophy guides my life.","My life is guided by me.",["belief", "intellection"],["self_assurance", "command"],"belief","self_assurance"],
  [175,"I spend at least five hours alone thinking each week.","I like to be with people.",["intellection", "relator"],["woo", "includer"],"intellection","woo"],
  [176,"I know my strengths better than my weaknesses.","I know my weaknesses better than my strengths.",["maximizer", "self_assurance"],["restorative", "deliberative"],"maximizer","restorative"],
  [177,"An interruption can be a worthwhile surprise.","My priorities are always clear.",["adaptability", "positivity"],["focus", "discipline"],"adaptability","focus"],
  [178,"Understanding the past is vital to confidence in the future.","I focus on today.",["context", "belief"],["adaptability", "focus"],"context","adaptability"],
  [179,"In life, there are no coincidences.","Not everything has special meaning.",["connectedness", "belief"],["analytical", "deliberative"],"connectedness","analytical"],
  [180,"If I get a bonus, I would prefer $1,000 now.","If I get a bonus, I would prefer $100 per month for one year.",["activator", "adaptability"],["deliberative", "focus"],"activator","deliberative"],
  [181,"I like to figure out why I failed.","I enjoy my successes.",["restorative", "analytical"],["positivity", "self_assurance"],"restorative","positivity"],
  [182,"Meeting new people gives me energy.","I regularly spend time with close friends.",["woo", "positivity"],["relator", "responsibility"],"woo","relator"],
  [183,"My life is like a book I keep writing exciting chapters for.","Sometimes I feel like life is moving too fast.",["activator", "futuristic"],["deliberative", "adaptability"],"activator","deliberative"],
  [184,"I have a clear set of guidelines that I live by.","The world is full of interesting things, and I want to try them all.",["belief", "responsibility"],["adaptability", "learner"],"belief","adaptability"],
  [185,"I like to focus on what I do best.","It is important to be well-rounded.",["maximizer", "self_assurance"],["consistency", "responsibility"],"maximizer","consistency"],
  [186,"I like to repair things.","I find troubleshooting exhausting.",["restorative", "analytical"],["deliberative", "adaptability"],"restorative","deliberative"],
  [187,"I am always thinking one step ahead.","My feelings guide my decisions.",["strategic", "futuristic"],["empathy", "belief"],"strategic","empathy"],
  [188,"When I make plans, I think about different possible outcomes.","It is hard to predict the future.",["strategic", "deliberative"],["adaptability", "self_assurance"],"strategic","adaptability"],
  [189,"I tend to be cautious.","Calculated risks make life more exciting.",["deliberative", "focus"],["activator", "adaptability"],"deliberative","activator"],
  [190,"Living in the past is a waste of time.","Those who do not learn from history are doomed to repeat it.",["adaptability", "activator"],["context", "learner"],"adaptability","context"],
  [191,"We should live our lives as examples for others.","The purpose of life is to be happy.",["belief", "responsibility"],["positivity", "adaptability"],"belief","positivity"],
  [192,"I can keep track of everything in the midst of chaos.","I prefer not to multitask.",["arranger", "adaptability"],["focus", "discipline"],"arranger","focus"],
  [193,"I like managing dynamic situations with many variables.","I like it best when things are simple and straightforward.",["arranger", "strategic"],["consistency", "deliberative"],"arranger","consistency"],
  [194,"Making decisions too quickly is reckless.","I don't like to wait for things to happen.",["deliberative", "responsibility"],["activator", "command"],"deliberative","activator"],
  [195,"I love routines.","I am spontaneous.",["discipline", "consistency"],["adaptability", "positivity"],"discipline","adaptability"],
  [196,"Overcoming weaknesses is how I succeed.","Developing my talents is how I succeed.",["restorative", "deliberative"],["maximizer", "self_assurance"],"restorative","maximizer"],
  [197,"If I get a surprise bill, I would prefer to pay $1,000 now.","If I get a surprise bill, I would prefer to pay $100 per month for one year.",["deliberative", "focus"],["adaptability", "activator"],"deliberative","adaptability"],
  [198,"I do my best work under pressure.","I do my best work with time to prepare.",["activator", "adaptability"],["deliberative", "discipline"],"activator","deliberative"],
  [199,"I think people should be more logical.","It is very easy for me to understand a person's feelings.",["analytical", "deliberative"],["empathy", "individualization"],"analytical","empathy"],
  [200,"I thrive at big events with lots of new faces.","I thrive in small groups with people I know well.",["woo", "includer"],["relator", "individualization"],"woo","relator"]
];
...
var PRIMARY_WEIGHT = 1.7;
var SECONDARY_WEIGHT = 0.6;
var CLUSTER_COEFF = 0.01;
var NEG_WEIGHT = 0.3;
...
/* ---- SCORING: Workbook v2 model ---- */
/* Primary themes get more weight than secondary themes.
   Scores normalized by max possible points per theme.
   Per-theme multipliers calibrate for systematic biases.
   Cluster items provide small correction for high-signal questions.
   Negative signals subtract from themes when statements contradict them. */
function calcScores(answers) {
  ...
  answers.forEach(function(a) {
    ...
    var val = a.val;
    var qid = q[0];
    var priA = q[5]; /* primary theme for side A */
    var priB = q[6]; /* primary theme for side B */
    ...
    /* Award points: primary gets PRIMARY_WEIGHT, secondary gets SECONDARY_WEIGHT */
    if (pointsA > 0) {
      tA.forEach(function(t) {
        var w = (t === priA) ? PRIMARY_WEIGHT : SECONDARY_WEIGHT;
        bins[t] += w * pointsA;
      });
    }
    if (pointsB > 0) {
      tB.forEach(function(t) {
        var w = (t === priB) ? PRIMARY_WEIGHT : SECONDARY_WEIGHT;
        bins[t] += w * pointsB;
      });
    }

    /* Negative signals: subtract from themes when statement contradicts them */
    var negKey = qid + (pointsA > 0 ? "A" : pointsB > 0 ? "B" : "");
    var neg = NEGATIVE_SIGNALS[negKey];
    if (neg && (pointsA > 0 || pointsB > 0)) {
      var pts = pointsA || pointsB;
      neg.forEach(function(t) { bins[t] -= NEG_WEIGHT * pts; });
    }
  });

  /* Normalize: divide earned by possible points per theme */
  var baseNorm = {};
  ALL_T.forEach(function(id) {
    baseNorm[id] = bins[id] / (SCORE_POSSIBLE[id] || 1);
  });

  /* Cluster correction: average signed response for high-signal items */
  var clusterAvg = {};
  ...
  /* AdjustedScore = BaseNorm * Multiplier + ClusterAvg * ClusterCoeff */
  var adjusted = {};
  ALL_T.forEach(function(id) {
    adjusted[id] = baseNorm[id] * (SCORE_MULTIPLIERS[id] || 1) + clusterAvg[id] * CLUSTER_COEFF;
  });
